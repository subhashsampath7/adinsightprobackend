...
const transporter = nodemailer.createTransport({
    host: 'smtp-relay.brevo.com', // කෙලින්ම Brevo host එක දානවා
    port: 2525,                   // **මේක තමයි වැදගත්ම දේ! (587 වෙනුවට 2525)**
    secure: false,                // Port 2525 ට false තමයි එන්න ඕනේ
    requireTLS: true,             // TLS අනිවාර්ය කරනවා
    auth: {
